  ...
  return (
    ...
    <>
      <main className={styles.main}>
        ...
        <div className={`${stl.failure} position-absolute top-50 start-50 translate-middle`}>
          <div className={`${stl.cards} card card-body mx-auto box-shadow text-center`} style={{ background: "#000000cc"}}> 
            ...
            <div className=" fs-5 fw-semibold text-light mb-5">
              Sorry you haven&apos;t registered yourself
            </div>
            <Link href='/busdb/userprofile' className={`${stl.yellowbtn} btn `} >Click here to Register</Link>
          </div>
        </div>
